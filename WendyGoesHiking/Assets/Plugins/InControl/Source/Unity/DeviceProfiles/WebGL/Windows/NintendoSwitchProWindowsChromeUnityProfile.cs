namespace InControl
{
	...
	public class NintendoSwitchProWindowsChromeUnityProfile : UnityInputDeviceProfile
	{
		public NintendoSwitchProWindowsChromeUnityProfile()
		{
			Name = "Nintendo Switch Pro Controller";
			Meta = "Nintendo Switch Pro Controller on Windows Chrome";
			...
			LastResortRegex = "Pro Controller";
